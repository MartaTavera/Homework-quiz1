...
export function HintBox({ hint, show, onToggle }) {
  return (
    <>
      ...
      {show && (
        <div style={{ background: "#fefce8", border: "1px solid #fde047", borderRadius: 7, padding: "10px 14px", fontSize: 15, color: "#713f12", marginBottom: 16 }} dangerouslySetInnerHTML={{ __html: hint }}/>
      )}
    </>
  );
}